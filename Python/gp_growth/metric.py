...
spec_growth = importlib.util.spec_from_file_location("data", "/Users/WRShoemaker/GitHub/Task2_Traits/Python/gp_growth/data/growth.py")
growth = importlib.util.module_from_spec(spec_growth)
spec_growth.loader.exec_module(growth)
